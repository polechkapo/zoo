...
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('Animals', [{
      name: 'Собакотелые',
      desc: '"Кроло-дог", "Кака-бигль", "Шарпогусь", "Ястребопесель" являются лишь малая доля представителей собакотелых, которых вы сможете встретить в Урюпинском зоопарке.',
      admin_id: 1,
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
