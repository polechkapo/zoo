    ...
    <Layout>
        ...
        <div className="mask">
          <div className="d-flex justify-content-center align-items-center h-100">
            <div className="text-white">
              <h1 className="mb-3">Добро пожаловать в Космический зоопарк</h1>
              <h4 className="mb-3">планета Марс, улица Ленина, дом 10</h4>
              <p className="main__desc">Космический зоопарк — один из старейших зоопарков галактики и единственный космический зоопарк. Его богатая коллекция насчитывает до 600 видов животных, птиц, рыб и беспозвоночных. Зоопарк считается одним из самых маленьких в мире, но в тоже время очень интересным для посещения, его площадь составляет всего 7,3 га.</p>
      ...
      <div className="content__animals">
        <div className="content__container">
          <h2 className="content__title">Обитатели Космического зоопарка</h2>
